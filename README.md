...
### Besoin principal
L’objectif du projet est **d’évaluer la compréhension et la maîtrise pratique** des concepts fondamentaux du développement web.

### Compétences évaluées
- Implémentation complète d’un **CRUD**
- Utilisation des **modals** pour les formulaires
- Mise en place d’une **recherche et d’un filtrage dynamiques via AJAX**
